...
const Chain = () => {
  ...
  //renders
  const renderBlocks = () => {
    return chain.map((block, index) => <Block className="mb-4" block={block} index={index} key={block.hash}></Block>)
  }
    ...
    <div>
      ...
      <div className="flex justify-between mb-4">
        <div>
          ...
          <input className="border border-grey-100 pl-2" value={difficulty} type="number" onChange={handleDifficulty}min="1"/>
        </div>
        <div>
