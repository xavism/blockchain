    ...
    <div className="mb-4">
      ...
      <div className="p-4 rounded bg-gray-100 w-full">
        ...
        <button
          ...
          onClick={handleAddTransaction} className="w-full py-1 px-4 rounded bg-gray-500 text-white focus:outline-none hover:bg-gray-600 disabled:bg-gray-200">Create</button>
      </div>
    </div>
  )
}
